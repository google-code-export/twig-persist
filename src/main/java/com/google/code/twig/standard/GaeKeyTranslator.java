 ...
 * (com.google.appengine.api.datastore.Key). The field with
 * the GAE Key can either be of the complex type Key or the String
 * encoded Key. The translator will determine which to use at runtime.
 * Simple annotate the field with @GaeKey
 * 
 * Example usage:
 * 
 * @GaeKey
 ...
 * @author Brad Seefeld
 */
public class GaeKeyTranslator implements PropertyTranslator {

	protected TranslatorObjectDatastore datastore;
	
	public GaeKeyTranslator(TranslatorObjectDatastore datastore) {
