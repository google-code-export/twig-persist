...
{
	public AutoGeneratedIdTest()
	{
		ObjectDatastoreFactory.register(HasStringKey.class);
		ObjectDatastoreFactory.register(HasIntKey.class);
		ObjectDatastoreFactory.register(HasLongKey.class);
	}
